#You can use this file as a reference or example for install a VM using a vagrantfile
#See others examples of how to install a VM without the vagrantfile 

Vagrant.configure("2") do |config|

  # Box image configuration  
